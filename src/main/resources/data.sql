insert into CUSTOMER(CUSTOMER_ID, NAME) values (1, 'Mykola');
insert into CUSTOMER(CUSTOMER_ID, NAME) values (2, 'Roman');
...
insert into BOOKING(BOOKING_ID, CUSTOMER_ID,ROOM_ID,FROM_DATE,UNTIL_DATE,ROOM_PRICE,SUMMARY_PRICE) values (1, 1, 12, '2019-01-01', '2019-05-01', 500, 800);

insert into BOOKING_OPTION(OPTION_TYPE_ID,BOOKING_ID,PRICE) values (1,1,300);

insert into BOOKING(BOOKING_ID, CUSTOMER_ID,ROOM_ID,FROM_DATE,UNTIL_DATE,ROOM_PRICE,SUMMARY_PRICE) values (2, 2, 12, '2019-08-01', '2019-10-01', 500, 500);